						...
						<div id="main-link-set" class="tab-pane fade active in">
							<form class="form" action="javascript:void(0)">
								...
								<div class="form-group form-group-lg">
									...
									<input type="text" id="form-set-remark" class="form-control" placeholder="短链接备注" autocomplete="off" />
								</div>
								<label>有效期自（可选）</label>
								<div class="form-group form-group-lg">
									<div class='input-group date date-picker'>
										<label for="form-set-valid-from" class="sr-only">Valid From</label>
										<input type='text' class="form-control" placeholder="留空表示不限制" id="form-set-valid-from" autocomplete="off" />
										<div class="input-group-addon">
								...
								<div class="form-group form-group-lg">
									<div class='input-group date date-picker'>
										...
										<input type='text' class="form-control" placeholder="留空表示不限制" id="form-set-valid-to" autocomplete="off" />
										<div class="input-group-addon">
											<span class="glyphicon glyphicon-calendar"></span>
										</div>
									</div>
						...
						<div id="main-link-multiset" class="tab-pane fade">
							<form class="form" action="javascript:void(0)">
								<div class="input-group-lg">
									...
									<textarea type="text" id="form-multiset-text" class="form-control" rows="10" autocomplete="off" placeholder="一行一个链接，不超过50个" required></textarea>
								</div>
								<label>备注（可选）</label>
								<div class="form-group form-group-lg">
									<label for="form-multiset-remark" class="sr-only">Custom Token</label>
									<input type="text" id="form-multiset-remark" class="form-control" placeholder="短链接备注" autocomplete="off" />
								</div>
								<label>有效期自（可选）</label>
								<div class="form-group form-group-lg">
									<div class='input-group date date-picker'>
										<label for="form-multiset-valid-from" class="sr-only">Valid From</label>
										<input type='text' class="form-control" placeholder="留空表示不限制" id="form-multiset-valid-from" autocomplete="off" />
										<div class="input-group-addon">
											<span class="glyphicon glyphicon-calendar"></span>
										</div>
									</div>
								...
								<div class="form-group form-group-lg">
									<div class='input-group date date-picker'>
										...
										<input type='text' class="form-control" placeholder="留空表示不限制" id="form-multiset-valid-to" autocomplete="off" />
										<div class="input-group-addon">
											<span class="glyphicon glyphicon-calendar"></span>
										</div>
									</div>
